...
## 📝 메모
A.sort()는 내부적으로 **문자열**로 비교하게 되는데,<br>
A.sort()로 사용하게 되면 [9, 20, 11] 배열을 정렬했을 때<br>
숫자가 작은 [9, 11, 20]으로 되는 것이 아닌<br>
[11, 20, 9] 순서로 정렬되게 된다.<br><br>

숫자로 정렬을 원하시면 A.sort((a,b) => a - b)로 정렬 해주어야 한다!<br>
_내림차순은 A.sort((a,b) => b - a)_
